...
<html lang="en">
  <head>
	...
	<script language="javascript" type="text/javascript" src="<?php echo $this->config->item('VIEWBASE'); ?>admin/chartsPlugin/flot/jquery.flot.js"></script>
	<script language="javascript" type="text/javascript" src="<?php echo $this->config->item('VIEWBASE'); ?>admin/chartsPlugin/flot/jquery.flot.resize.min.js"></script>
	<script src="<?php echo $this->config->item('VIEWBASE'); ?>admin/js/blockUI.js"></script>
...
<a class="btn" href="<?php echo site_url('admin/logout')?>"><i class="icon-user"></i>Logout</a>
