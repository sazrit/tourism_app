...
--
-- Host: localhost
-- Generation Time: Jul 01, 2015 at 09:37 PM
...
('east bibirbazar road,comilla,bangladesh', 23.45, 91.2),
...
(16, 53, 10, 4, 7, 0, 1, 35, 'Moheskhali is a very good place to visit'),
(17, 53, 10, 10, 2, 0, 1, 35, 'Awesome Place.....'),
(18, 45, 10, 10, 10, 0, 1, 35, 'It''s  A great Place');
...
INSERT INTO `tourist_spot` (`id`, `did`, `place_address`, `place_name`, `cost_of_visit`, `cost_type`, `description`, `comment_id`, `type_id`) VALUES
(38, 13, 'chitagong', 'Patenga beach', 120, 'cheap', 'A tourist attraction near Patenga beach is the Butterfly Park', 0, 1),
(39, 11, 'Lalbagh, Dhaka', 'Lalbagh Fort', 500, 'cheap', 'Built in 1678 by the Viceroy of Bengal, it contains a three-domed mosque, the tomb of Pari Bibi, the reputed daughter of Nawab Shaista Khan, the Audience Hall and the hammam of the Governor. Four Kilometres from the hotel. Ahsan Manzil Palace Museum ', 0, 3),
(40, 11, 'Savar, Bangladesh', 'Jatiyo Sriti Shoudho', 600, 'cheap', 'Jatiyo Sriti Shoudho or National Martyrs'' Memorial is the national monument of Bangladesh is the symbol in the memory of the valour and the sacrifice of all those who gave their lives in the Bangladesh ', 0, 1),
(41, 11, 'Armanitola,Dhaka', 'Star Mosque', 500, 'cheap', 'Star Mosque, is a mosque located in Armanitola area, Dhaka, Bangladesh. The mosque has ornate designs and is decorated with motifs of blue stars. It was built in the first half of the 19th century by Mirza Golam Pir.', 0, 3),
(42, 11, 'Rahmatganj, Dhaka', 'Bara Katra', 600, 'cheap', 'Bara Katra is a historical and architectural monument located in the city of Dhaka, Bangladesh.‘Katra/ katara’ in Arabic and Persian means ‘Caravan Sarai’ or simply a ‘Sarai’', 0, 0),
(43, 11, 'Bakshi Bazar, Dhaka', 'Hussaini Dalan', 400, 'cheap', 'The Hussaini Dalan was originally built during the later half of the Mughal rule in Dhaka. It was built as the Imambara or house of the imam of the Shia community.', 0, 0),
(44, 11, 'Kumartoli,Dhaka ', 'Ahsan Manzil', 600, 'cheap', 'Ahsan Manzil was the official residential palace and seat of the Dhaka Nawab Family. This magnificent building is situated at Kumartoli along the banks of the Buriganga River in Dhaka, Bangladesh.', 0, 0),
(45, 29, 'Mainamati,Commila', 'Mainamati', 1500, 'cheap', 'Mainamati  is an isolated low, dimpled range of hills, dotted -with more than 50 ancient Buddhist settlements of the 8th to 12th century A.D. It is extended through the centre of the district of Comilla. Mainamati is located almost 8 miles from the t', 0, 0),
(46, 29, ' East Bibirbazar Road,Comilla', 'Comilla Jagannath Temple', 1000, 'cheap', 'Comilla Jagannath Temple, also known as "Saptaratna Mandir", is a temple dedicated to the Hindu God Jagannath in Comilla, Bangladesh. It dates back to the 16th century, and was built by Sree Sreejoktou Moharaja Rada Kishor Manikuo Bahadur, who was th', 0, 0),
(47, 13, 'Patenga,Chittagong', 'Patenga', 2000, 'Moderate', 'Patenga is a sea beach located 14 kilometres south of the port city of Chittagong, Bangladesh. It is near the mouth of the Karnaphuli River.', 0, 0),
(48, 20, 'laboni beach, cox''s bazar', 'Cox''s Bazar sea beach', 3000, 'Moderate', 'The beach is the main attraction of the Cox''s Bazar. Larger hotels provide exclusive beachside area with accessories for the hotel guests. Visitors in other hotels visit the Laboni beach which is the area of the beach closest to the town.', 0, 0),
(49, 20, 'Himchari National Park, cox''s ba', 'Himchari National Park', 3000, 'Moderate', 'Himchari is located just south of the Cox’s Bazar town. It consists of lush tropical rain forest, grasslands and trees, and features a number of waterfalls, the biggest of which cascades down toward the sandy, sun-drenched beach. The National Park wa', 0, 0),
(50, 20, 'Aggmeda Khyang, cox''s bazar', 'Aggmeda Khyang', 3000, 'Moderate', 'Aggmeda Khyang: a large Buddhist monastery, and a place revered by around 400,000 Buddhist people of Cox’s Bazar; and the Chittagong Hill Tracts. The main sanctuary is posted on a series of round timber columns. It has a prayer chamber and an assembl', 0, 0),
(51, 20, 'Ramu, cox''s bazar', 'Ramu', 3000, 'Moderate', 'Ramu is about 10 km from Cox’s Bazar, is a village with a sizeable Buddhist population. The village is famous for its handicrafts and homemade cigars. There are monasteries, khyangs and pagodas containing images of Buddha in bronze, gold and other me', 0, 0),
(52, 20, 'Inani Beach, cox''s bazar', 'Inani Beach', 3500, 'Moderate', 'Inani Beach is another magnificent place to see. Inani is full of stony beach and the calmness and serenity of Inani is mind blowing. Don''t miss the chance to visit Inani while going to Cox''s Bazar.', 0, 0),
(53, 20, 'Maheshkhali, cox''s bazar', 'Maheshkhali', 4000, 'Moderate', 'Maheshkhali is a small island (268 square kilometres) off the Cox’s Bazar coast. The island offers panoramic scenic beauty and is covered by a range of low hills, about 300 feet (91 m) high, streatches through the center of the island and along its e', 0, 0),
(54, 20, 'Sonadia Island, cox''s bazar', 'Sonadia Island', 4500, 'Moderate', 'Sonadia Island, a small crescent shaped island of only 9 square kilometres, it is 7-km north-west of Cox''s Bazar. The western side of the island is sandy and different kinds of shells are found on the beach. Off the northern part of the island, there', 0, 0),
(55, 20, 'Teknaf, cox''s bazar', 'Teknaf', 5000, 'Moderate', 'Teknaf, a place situated by the side of Naf river is the southernmost part of mainland Bangladesh. This also marks the end point of Cox''s Bazar beach. Tourists usually come here to have a river cruise along beautiful Naf river, which flows between Ba', 0, 0),
(56, 20, 'St. Martin''s Island , cox''s baza', 'St. Martin''s Island ', 7000, 'Luxury', 'St. Martin''s Island is a small island in the northeastern part of the Bay of Bengal, about 9 km south of the tip of the Cox''s Bazar-Teknaf peninsula, and forming the southernmost part of Bangladesh', 0, 0),
(57, 20, 'Kutubdia, cox''s bazar', 'Kutubdia', 5000, 'Moderate', 'Kutubdia is an Upazila of Cox''s Bazar District in the Division of Chittagong, Bangladesh. The upazila consists of an island in the Bay of Bengal, off the coast near Chakaria, Cox''s Bazar', 0, 0),
(58, 23, 'Shaila Propat , Bandarban', 'Shoilo Propat Bandarban', 7000, 'luxury', 'Shoilo Propat:the waterfall named Shoilo Propat at Milanchari, It is a excellent site maintained by Bangladesh Parjatan, the national tourism promotion corporation.It is 8km away from Bandarban town on the Bandarban Ruma road. This is one of the most', 0, 0),
(59, 23, 'Nilachal , Bandarban', 'Nilachal ', 7000, 'Luxary', 'Nilachal is the nearest tourist spot from Bandarban. It is situated at Tigerpara. It is near about 2000 feet above of sea level and 5 kilometer away from the Bandarban town. From here visitor can see the total glance of Bandarban town and a vast land', 0, 0),
(60, 23, 'Nilgiri , Bandarban', 'Nilgiri ', 6000, 'Moderate', 'Nilgiri or Nil Giri is one of the tallest peaks and beautiful tourist spot in Bangladesh. It is about 3500 feet high and situated at Thanci Thana. It is about 46 km south of Bandarban on the Bandarban-Chimbuk-Thanchi road.', 0, 0),
(61, 23, 'Buddha Dhatu Jadi , Bandarban', 'Buddha Dhatu Jadi(Golden Temple)', 6000, 'Moderate', 'The Buddha Dhatu Jadi (also known as the Bandarban Golden Temple) is located close to Balaghata town, in Bandarban City, in Bangladesh. Dhatu are the material remains of a holy person, and in this temple the relics belong to Buddha. It is the largest', 0, 0),
(62, 23, 'Boga Lake,Bandarban', 'Boga Lake', 7000, 'Luxary', 'Bagakain Lake, also called Baga Lake or Boga Lake, is a lake located in Ruma Upazila in the hill district Bandarban, Bangladesh.It is a natural sweet and deep water lake. Its height from sea level is nearly 2,000 feet (610 m). Geologists believe that', 0, 0),
(63, 11, 'Shaheed Minar, Dhaka', 'Shaheed Minar', 500, 'cheap', 'The Shaheed Minar  is a national monument in Dhaka, Bangladesh, established to commemorate those killed during the Bengali Language Movement demonstrations of 1952.\n\nOn February 21, 1952, dozens of students and political activists were killed when th', 0, 0),
(64, 11, 'Mohammadpur, Dhaka', 'Jatiya Sangsad', 500, 'cheap', 'Jatiyo Sangsad Bhaban or National Parliament House,  is the house of the Parliament of Bangladesh, located at Sher-e-Bangla Nagar in the Bangladeshi capital of Dhaka. Designed by architect Louis Kahn, the complex, is one of the largest legislative co', 0, 0),
(65, 13, 'Rangamati, Chittagong Division', 'Rangamati', 6000, 'Luxuary', 'Rangamati is a district in South-eastern Bangladesh. It is a part of the Chittagong Division and the town of Rangamati serves as the headquarters of the district. Area-wise, Rangamati is the largest district of the country.', 0, 0),
(66, 13, 'Khagracharii,Chittagong Division', 'Khagrachari', 7000, 'Luxary', 'Khagrachhari is a district in south-eastern Bangladesh. It is a part of the Chittagong Division and the Chittagong Hill Tracts. Its local name is "Chengmi". Khagrachhari is also known as Phalang Htaung or the Mong Circle.', 0, 0),
(67, 13, '', 'Foy''s Lake', 0, '', '', 0, 0),
(68, 13, '', 'Heritage Park', 0, '', '', 0, 0),
(69, 13, '', 'Ethnological Museum of Chittagon', 0, '', '', 0, 0),
(70, 13, '', 'WWII cemetery and Circuit House', 0, '', '', 0, 0),
(71, 19, '', 'Somapura Mahavihara', 0, '', '', 0, 0),
(72, 19, '', 'Mahastangar', 0, '', '', 0, 0),
(78, 19, '', 'Behula Lakshindar Basor Ghor', 0, '', '', 0, 0),
(79, 22, '', 'Kantajew Temple', 0, '', '', 0, 0),
(80, 19, '', 'Varendra Research Museum', 0, '', '', 0, 0),
(81, 19, '', 'Bagha Mosque', 0, '', '', 0, 0),
(82, 30, '', 'Kuakata Beach', 0, '', '', 0, 0),
(83, 17, '', 'Sundarbans', 0, '', '', 0, 0),
(86, 17, '', 'Bagerhat', 0, '', '', 0, 0);
...
INSERT INTO `traveler_cart` (`id`, `user_id`, `cart_id`, `center`, `place_id`, `hotel_id`, `journey_name`) VALUES
(327, 35, '35Bandarban', '', 58, 0, ''),
(328, 35, '35Bandarban', '', 60, 0, ''),
(329, 35, '35Bandarban', '', 58, 0, ''),
(330, 35, '35Bandarban', '', 59, 0, ''),
(331, 35, '35Bandarban', '', 58, 0, ''),
(332, 35, '35Bandarban', '', 59, 0, ''),
(333, 35, '35Bandarban', '', 60, 0, ''),
(334, 35, '35Bandarban', '', 58, 0, ''),
(335, 35, '35Bandarban', '', 59, 0, ''),
(336, 35, '35Bandarban', '', 61, 0, '');
...
(44, 'shabujbag', 0, 'jahid4556@gmail.com', '121212', 1, 'jahidul  haque', 'Dhaka');
